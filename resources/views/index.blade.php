                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">C$ {{$ver['ingresos'] - $ver['egresos']}}</div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                        </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <h4 class="small font-weight-bold">Beca C$ {{$ver['becas']}} <span
                            class="float-right">{{$ver['porcentaje']}} %</span><small>{{$ver['personas']}} beca(s)</small></h4>
                    <div class="progress mb-4">
